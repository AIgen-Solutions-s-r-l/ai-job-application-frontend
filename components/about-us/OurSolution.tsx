...
export const Point = ({ text }: { text: string }) => {
    return (
        <div className='flex items-center justify-center gap-10'>
            ...
            <p className="font-montserrat text-black text-[20px] font-[400]">
                {text}
            </p>
        </div>
    );
...
function OurSolution() {
    return (
        <div className="flex flex-col px-24 gap-8">
            <p className="font-montserrat text-black text-[50px] font-semibold">Our Solution</p>
            <p className="font-montserrat text-black text-[40px] font-[400]">LABORO offers a high-tech platform designed to automate and optimize job applications. Our key features include:</p>
