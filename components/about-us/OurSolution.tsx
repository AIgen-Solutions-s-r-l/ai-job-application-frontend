...
function OurSolution() {
    return (
        <div className="flex flex-col px-4 sm:px-8 md:px-16 lg:px-24 gap-4 md:gap-8">
            ...
            <p
            className="font-montserrat text-black text-xl md:text-2xl lg:text-[40px] font-[400]"
            style={{ lineHeight: '1.1' }}
            >LABORO offers a high-tech platform designed to automate and optimize job applications. Our key features include:</p>
