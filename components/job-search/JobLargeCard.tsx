      ...
      <div className='flex flex-col justify-between gap-3 border-b border-b-1 border-b-primary pb-5'>
        <div className='flex items-center justify-between gap-5'>
          <div className='flex items-center gap-2 xl:gap-4'>
            <h3 className="text-[20px] xl:text-[40px] leading-[1.1] font-montserrat font-semibold">{job.company}</h3>
            <Image src={Nike} alt='Logo' />
          </div>
          <button onClick={() => window.open('https://google.com', 'blank')} className='font-jura text-sm xl:text-[18px] leading-none px-3 py-2 xl:px-6 xl:py-4 border border-neutral-cold-1 bg-white rounded-[20px] hover:bg-primary hover:text-white transition-colors ease-in duration-200' >View Original Job Post</button>
        </div>
