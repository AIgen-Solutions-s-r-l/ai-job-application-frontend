...
export const Header: React.FC = () => {
  return (
    <header className='bg-primary-light-purple font-montserrat pt-4 md:pt-[30px] 2xl:pt-[50px]'>
      <LandingContainer className='flex gap-10 justify-between'>
        <div>
          <Link
            href="/"
          >
          ...
          <p className="text-[11px] md:text-[16px] 2xl:text-[21px] font-medium text-splash-green ml-1 md:ml-[7px] mt-1 2xl:mt-[10px]">Revolutionizing the job market with AI</p>
        </div>
        <div className="flex flex-col md:flex-row gap-2 2xl:gap-5 font-k2d mt-2 md:mt-5">
          <Link className='order-1 md:-order-1 h-[30px] md:h-[56px] px-5 flex items-center justify-center md:justify-between border border-white rounded-[8px] md:rounded-[20px] gap-2' href='/'>
          ...
          <Link className='h-[30px] md:h-[56px] px-5 flex items-center justify-center md:justify-between bg-splash-green rounded-[8px] md:rounded-[20px] gap-2' href='/signin'>
