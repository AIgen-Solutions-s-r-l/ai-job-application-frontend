  ...
  return (
    <LandingContainer>
      <section className='flex flex-col items-center gap-[70px] xl:gap-[100px] bg-primary-light-purple font-montserrat py-[120px] md:py-[180px] 2xl:py-[240px]'>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 xl:gap-14 items-center 2xl:px-[100px] -mt-[40px]">
          ...
          <Image src="/landing/spotlight-3.png" alt="spotlight-3" width={320} height={54} />
