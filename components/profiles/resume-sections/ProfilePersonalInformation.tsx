...
export const ProfilePersonalInformation: FC = () => {
  ...
  return (
    <div className="collapse collapse-arrow group rounded-none">
      ...
      <div className="collapse-title !pl-5 text-base md:text-lg lg:text-xl font-montserrat font-medium bg-my-neutral-2 group-has-[input:checked]:bg-base-100 flex items-center justify-between">Personal Information
