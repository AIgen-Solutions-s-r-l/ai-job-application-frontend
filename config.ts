...
const config = {
  ...
  stripe: {
    ...
    pricing: {
      monthly: {
        "100": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0iUvRwjs1KsbvtM3plVfZG" : "price_1QwoTpRwjs1KsbvtvJsfY6Mh",
          amount: 39.00
        },
        "200": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0iVcRwjs1KsbvtK3hFIzVG" : "price_1QwoUbRwjs1Ksbvt2GTzE3Ec",
          amount: 59.00
        },
        "300": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0iXjRwjs1KsbvtlrGsjlq8" : "price_1QwoV4Rwjs1KsbvtpCV0OIfU",
          amount: 74.00
        },
        "500": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0iYuRwjs1Ksbvt04IxJfpM" : "price_1QwoVSRwjs1KsbvtHfSnJvv4",
          amount: 105.00
        },
        "1000": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0iZkRwjs1Ksbvttrg1BoLb" : "price_1QwoVuRwjs1Ksbvtmpxx2KgP",
          amount: 160.00
        }
      },
      onetime: {
        "100": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0iaERwjs1KsbvtLR7ZGywu" : "price_1QyZ11Rwjs1KsbvtHsJnKlAP",
          amount: 49.00
        },
        "200": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0ibbRwjs1KsbvtUaTwEjYy" : "price_1QyZ2mRwjs1KsbvtHs6pHIXs",
          amount: 74.00
        },
        "300": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0icBRwjs1KsbvtxxGqqdao" : "price_1QyZ3yRwjs1KsbvtAUS7hrhr",
          amount: 89.00
        },
        "500": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0ienRwjs1KsbvtTd6n0k06" : "price_1QyZAERwjs1KsbvtqSj1yIvw",
          amount: 115.00
        },
        "1000": {
          id: process.env.TARGET_ENV === 'development' ? "price_1R0j22Rwjs1KsbvtAltBEhzf" : "price_1QyZBlRwjs1Ksbvt4T4t3pOd",
          amount: 199.00
        }
      }
    },
    ...
    plans: [
      {
        ...
        priceId: process.env.TARGET_ENV === 'development' ? "price_1R0iUvRwjs1KsbvtM3plVfZG" : "price_1QwoTpRwjs1KsbvtvJsfY6Mh",
      ...
      },
      {
        ...
        priceId: process.env.TARGET_ENV === 'development' ? "price_1R0iYuRwjs1Ksbvt04IxJfpM" : "price_1QwoVSRwjs1KsbvtHfSnJvv4",
      ...
      },
      {
        ...
        priceId: process.env.TARGET_ENV === 'development' ? "price_1R0iaERwjs1KsbvtLR7ZGywu" : "price_1QyZ11Rwjs1KsbvtHsJnKlAP",
